...
return [
    ...
    'attributes' => [
        ...
        'trocas.*.valor_troca'    => 'valor avaliado do veículo de troca',
        'trocas.*.marca'          => 'marca do veículo de troca',
        'trocas.*.modelo'         => 'modelo do veículo de troca',
        'trocas.*.versao'         => 'versão do veículo de troca',
        'trocas.*.ano_fabricacao' => 'ano de fabricação do veículo de troca',
        'trocas.*.ano_modelo'     => 'ano do modelo do veículo de troca',
        'trocas.*.km'             => 'quilometragem do veículo de troca',
        'trocas.*.cor'            => 'cor do veículo de troca',
        'trocas.*.categoria'      => 'categoria do veículo de troca',
        'trocas.*.combustivel'    => 'combustível do veículo de troca',
        'trocas.*.transmissao'    => 'transmissão do veículo de troca',
        'interesse'   => 'interesse',
        'origem'      => 'origem',
        'descricao'   => 'descrição',
        'valor'       => 'valor',
